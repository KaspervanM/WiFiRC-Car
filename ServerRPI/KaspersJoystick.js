...
$(document).ready(setTimeout(function() {
  ...
  joystick.style.width =
      (33 * joystick_box.clientWidth / 100).toString().concat("px");
  joystick.style.height =
      (33 * joystick_box.clientHeight / 100).toString().concat("px");
...
function getPos(parentonly = -1) {
  ...
  joystick_box_pos_middle.y =
      joystick_box_pos.top +
      (joystick_box_pos.bottom - joystick_box_pos.top) / 2;
